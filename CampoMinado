...
public class CampoMinado extends JFrame implements MouseListener {
    ...
    ArrayList<JLabel> qdds = new ArrayList<>() {{
        add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());
        add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());
        add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());
        add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());
        add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());add(new JLabel());
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        boolean acabou = true;
        for (JLabel qdd : qdds){
            if (qdd.getBackground() == Color.gray){
                acabou = false;
            }
        }
        if (acabou){
